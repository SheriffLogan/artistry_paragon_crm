...
const FlushAccordion = () => {
	const [flushAccordion, setFlushAccordion] = useState(0)

	const handleFlushAccordion = (index) => () => {
...
const SimpleCardAccordion = () => {
	const [cardAccordion, setCardAccordion] = useState(0)

	const handleCardAccordion = (index) => () => {
...
const IconAccordion = () => {
	const [iconAccordion, setIconAccordion] = useState(0)

	const handleIconAccordion = (index) => () => {
...
const NoArrowAccordion = () => {
	const [noArrowAccordion, setNoArrowAccordion] = useState(0)

	const handleNoArrowAccordion = (index) => () => {
