        ...
        <>
            <Transition appear show={open} as={Fragment}>
                <Dialog as="div" className="relative" onClose={toggleOffcanvas}>
                    ...
                    <Transition.Child as={Fragment} enter="ease-out duration-300" enterFrom={enterFrom} enterTo={enterTo} leave="ease-in duration-200" leaveFrom={enterTo} leaveTo={enterFrom}>
