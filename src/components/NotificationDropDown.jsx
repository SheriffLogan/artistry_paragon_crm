						...
						{(notifications || []).map((notification, idx) => {
							...
							if (previousDate !== currentDate) {
								...
								if (todayDate === currentDate) {
									...
									labelName = `${new Date(notification.createdAt).toLocaleDateString()}`;
								}
								return (
												...
												<div className="flex items-center">
													<div className="flex-shrink-0">
														{notification.avatar ? (
															...
															<div className={`flex justify-center items-center h-9 w-9 rounded-full text-white bg-${notification.bgColor}`}>
