...
const MENU_ITEMS = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        key: 'analytics-other-channels',
        label: 'Other Channels',
        url: '/analytics/other-channels',
        parentKey: 'analytics',
      },
    ],
  },

  {
    ...
    children: [
      { key: 'products-categories', label: 'Categories', url: '/products/categories', parentKey: 'products' },
      { key: 'products-images', label: 'Images', url: '/products/images', parentKey: 'products' },
      { key: 'products-descriptions', label: 'Content Descriptions', url: '/products/descriptions', parentKey: 'products' },
      { key: 'products-variants', label: 'Variants', url: '/products/variants', parentKey: 'products' },
    ],
  },

  {
    ...
    children: [
      { key: 'orders-all', label: 'All Orders', url: '/orders/all', parentKey: 'orders' },
      { key: 'orders-returns', label: 'Return Requests', url: '/orders/returns', parentKey: 'orders' },
    ],
  },
...

  {
    ...
    icon: 'ri-settings-3-line',
    children: [
      { key: 'settings-store', label: 'Store Settings', url: '/settings/store', parentKey: 'settings' },
