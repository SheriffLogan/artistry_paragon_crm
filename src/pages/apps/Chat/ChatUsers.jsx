...
const ChatUsers = ({ onUserSelect, chatToggler }) => {
        ...
        <div className="mb-3">
          <form>
            <div className="relative flex rounded-md">
              <input onKeyUp={(e) => search(e.target.value)} type="text" id="trailing-button-add-on-with-icon-and-button" name="trailing-button-add-on-with-icon-and-button" className="form-input form-input-light ps-9" placeholder="People, groups & messages..." />
